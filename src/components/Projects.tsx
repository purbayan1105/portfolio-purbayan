...
const Projects = () => {
  const projectArray = [
    ...
    },
    {
      pId: 10,
      pImg: "/ran-api.jpg",
      pHead: "Api Fetching And Rendering",
      pDes: "The Apidata is collected from the website random api. The data is fetched using axios and rendered using tanstack query",
      pBtn: "Click Here",
      pSrc: "https://random-api-axios.netlify.app/",
      pb: [
        { pb1: "React" },
        { pb2: "Next UI" },
        { pb3: "Jotai" },
    ...
    },
    {
      pId: 13,
      pImg: "/ecomdummy.jpg",
      pHead: "Dummy Ecommerce Website",
      pDes: "It's an ecommerce website named Stereoverse, works exactly like ecommerce website from individual product page to checkout your orders",
      pBtn: "Click Here",
      pSrc: "https://ecomstereoverse.netlify.app/",
      pb: [
        { pb1: "React" },
        { pb2: "Next UI" },
        { pb3: "Jotai" },
    ...
    //   pId: 12,
    //   pImg: "/omnify.jpg",
    //   pHead: "Assignment Omnify",
    //   pDes: "It's an assignment by Omnify, A Table of data can be made visible or invisible with the corresponding checkboxes clicked",
    //   pBtn: "Click Here",
    //   pSrc: "https://ecomstereoverse.netlify.app/",
    //   pb: [
    //     { pb1: "React" },
    ...
    },
    {
      ...
      pBtn: "Click Here",
      pSrc: "https://get-things-done-app.netlify.app/",
      pb: [
        { pb1: "React" },
        { pb2: "Next UI" },
        { pb3: "Jotai" },
